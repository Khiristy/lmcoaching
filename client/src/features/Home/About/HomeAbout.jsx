      ...
      <div className="HomeAbout_container">
        ...
        <div className="HomeAbout_container-right">
          ...
          <p className="HomeAbout_container-right--text">
            ...
            m&apos;ont appris des valeurs essentielles telles que la discipline,
            la résilience, le respect et le dépassement de soi.
            <br />
            <br /> J&apos;ai concouru dans la catégorie Men&apos;s Physique et
            terminé vice-champion de France. Cette expérience a marqué le début
            d&apos;un parcours riche en compétitions et en succès sportifs.
            <br />
